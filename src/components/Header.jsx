...
export default function Header({ showMenu, showSide, setShowMenu, setShowSide, navItems }) {
  return (
    <header
      className={`fixed right-0 top-0 z-50 h-28 border-b border-gray-200 bg-white px-4 sm:h-16 sm:px-6 lg:px-8 ${
        showSide ? 'w-full lg:w-[calc(100%_-_288px)]' : 'w-full'
      }`}
    >
